    ...
    <div className="space-y-4">
      <div>
        ...
        <input
          ...
          className="w-full rounded-lg border border-gray-200 bg-gray-50/50 px-3 py-2 text-sm text-gray-900 outline-none transition-all placeholder:text-gray-400 focus:border-primary-400 focus:bg-white dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100"
          autoFocus
        />
      </div>
      ...
      <div>
        ...
        <textarea
          ...
          rows={6}
          className="w-full resize-none rounded-lg border border-gray-200 bg-gray-50/50 px-3 py-2 text-sm text-gray-900 outline-none transition-all placeholder:text-gray-400 focus:border-primary-400 focus:bg-white dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100"
        />
      </div>
...
export function CustomAgentsPanel({ spaceId, onClose }: CustomAgentsPanelProps) {
        ...
        {mode === "list" && (
          <>
            ...
            <button
              ...
              className="mb-5 flex w-full cursor-pointer items-center justify-center gap-2 rounded-xl border-2 border-dashed border-gray-200 py-3 text-xs font-medium text-gray-500 transition-all hover:border-primary-300 hover:bg-primary-50/50 hover:text-primary-600 dark:border-gray-700 dark:hover:border-primary-600 dark:hover:bg-primary-950/20 dark:hover:text-primary-400"
            >
              <FiPlus size={14} />
              Create new agent
            </button>
